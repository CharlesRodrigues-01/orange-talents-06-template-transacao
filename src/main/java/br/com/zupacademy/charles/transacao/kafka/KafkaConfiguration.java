...
public class KafkaConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, TransacoesResponse> transactionConsumerFactory() {
        StringDeserializer stringDeserializer = new StringDeserializer();
        JsonDeserializer<TransacoesResponse> jsonDeserializer = new JsonDeserializer<>(TransacoesResponse.class, false);
